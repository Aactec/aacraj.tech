...
const HeroComponent = () => {
    return (
        <>
                    <section className='flex justify-between items-center m-auto w-[80%]'>
            <div className="font-revalia w-[65%]">
                <p className='bg-primary px-4 py-2 w-24 rounded-t-2xl rounded-r-2xl font-redrose my-2 text-white'>Hello I'm</p>
                <h1 className='text-6xl font-extrabold font-russo'>Al-ameen Raji</h1>
                <h3 className='text-xl pb-1'>I'm a Front-end Developer</h3>
